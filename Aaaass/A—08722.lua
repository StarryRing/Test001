...
WindUI:Popup({
    Title = '<font color="' .. gradientColors[1] .. '">MR-</font><font color="' .. gradientColors[5] .. '">S</font>',
    IconThemed = true,
    Content = "尊敬的用户 " .. coloredUsername .. " \n您使用的 <font color='" .. gradientColors[1] .. "'>MR-</font><font color='" .. gradientColors[5] .. "'>S</font> 当前版本型号是: " .. coloredVersion .. "\n现已支持999+个服务器！",
    Buttons = {
        {
            Title = "取消",
